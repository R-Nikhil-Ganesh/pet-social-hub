  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <FlatList
        ...
        refreshControl={
          <RefreshControl refreshing={refreshing} onRefresh={() => loadFollowing(1, true)} tintColor={colors.brand.primary} />
        }
        renderItem={({ item }) => {
        ...
        ListEmptyComponent={
          <View style={styles.emptyWrap}>
            <EmptyState emoji="🧭" title="Not following anyone yet" subtitle="No profiles are being followed yet." />
          </View>
        }
